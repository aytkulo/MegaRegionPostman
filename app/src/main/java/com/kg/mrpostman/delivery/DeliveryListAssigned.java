...
public class DeliveryListAssigned extends AppCompatActivity {
     ...
     //   dialog.show();
        ...
        listViewDeliveries.setOnItemClickListener((parent, view, position, id) -> {
            ...
            delivery = (Delivery) parent.getItemAtPosition(position);
                Intent intentDelivery = new Intent(DeliveryListAssigned.this, DeliveryAssign.class);
    ...
    public void listDeliveries(final String entryDate, final String phone) throws ParseException {
        ...
        if (!NetworkUtil.isNetworkConnected(DeliveryListAssigned.this)) {
            MyDialog.createSimpleOkErrorDialog(DeliveryListAssigned.this,
            ...
            try {
                ...
                jsonObject.put("receiverCity", userCity);
                jsonObject.put("senderCity", senderCity+"%");
                jsonObject.put("phone", phone + "%");
                jsonObject.put("assignedSector", userName);
            } catch (JSONException e) {
                e.printStackTrace();
            }

            CustomJsonArrayRequest req = new CustomJsonArrayRequest(Request.Method.POST, AppConfig.URL_PARCEL_LIST_ASSIGNED, jsonObject,
                    response -> {
                        hideDialog();
                        ...
                        try {
                            ...
                            if (response.length() > 0) {
                                ...
                                if (deliveryList.size() > 0) {
                                    DListAdapterAssigning orderListAdapter = new DListAdapterAssigning(deliveryList, DeliveryListAssigned.this);
                                ...
                                Toast.makeText(DeliveryListAssigned.this, getApplicationContext().getString(R.string.NoData), Toast.LENGTH_LONG).show();
                            }
                        } catch (JSONException e) {
                            MyDialog.createSimpleOkErrorDialog(DeliveryListAssigned.this,
                                    getApplicationContext().getString(R.string.dialog_error_title),
                        ...
                        NetworkUtil.checkHttpStatus(DeliveryListAssigned.this, error);
                        hideDialog();
                    }) {
