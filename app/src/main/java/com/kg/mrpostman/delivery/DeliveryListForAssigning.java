...
public class DeliveryListForAssigning extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewDeliveries.setOnItemClickListener((parent, view, position, id) -> {
            ...
            delivery = (Delivery) parent.getItemAtPosition(position);
                Intent intentDelivery = new Intent(DeliveryListForAssigning.this, DeliveryAssign.class);
    ...
    public void listDeliveries(final String entryDate, final String phone) throws ParseException {
        ...
        if (!NetworkUtil.isNetworkConnected(DeliveryListForAssigning.this)) {
            MyDialog.createSimpleOkErrorDialog(DeliveryListForAssigning.this,
            ...
            CustomJsonArrayRequest req = new CustomJsonArrayRequest(Request.Method.POST, AppConfig.URL_PARCEL_LIST_FOR_ASSIGNING, jsonObject,
                    response -> {
                        hideDialog();
                        ...
                        try {
                            ...
                            if (response.length() > 0) {
                                ...
                                if (deliveryList.size() > 0) {
                                    DListAdapterAssigning orderListAdapter = new DListAdapterAssigning(deliveryList, DeliveryListForAssigning.this);
                                ...
                                Toast.makeText(DeliveryListForAssigning.this, getApplicationContext().getString(R.string.NoData), Toast.LENGTH_LONG).show();
                            }
                        } catch (JSONException e) {
                            MyDialog.createSimpleOkErrorDialog(DeliveryListForAssigning.this,
                                    getApplicationContext().getString(R.string.dialog_error_title),
                        ...
                        NetworkUtil.checkHttpStatus(DeliveryListForAssigning.this, error);
                        hideDialog();
                    }) {
